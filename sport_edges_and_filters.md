...
- **2026-06-19 (football round settlements)**: Added short post-settlement review for the 2026-06-19 football round (Hinna-Brodd, Ranheim-Lyn Over 2.5 + half-time BTTS). Confirmed value in Over 2.5 and half-time BTTS props in open Norwegian domestic games. Half-time BTTS at ~3.15 can be a repeatable small-stake exploratory market. No major filter changes. Equity now 411.80 NOK. All pushes validated.
- **2026-06-19 (Irish + Athletics round + multi-round settlements)**: Added post-settlement review for Irish leagues (Cork O2.5, Bray win) and first Athletics H2H exploratory bet (Arce win). All three hit. First athletics exploratory succeeded, supporting continued small-stake testing of athletics H2H on experienced vs emerging athletes when recent form supports edge. Equity now 422.30 NOK. All pushes validated.
