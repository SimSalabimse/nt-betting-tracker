...
HIGH_SCRIPTS = frozenset({"high_scoring", "shootout", "open", "attacking"})
LOW_SCRIPTS = frozenset({"low_scoring", "cagey", "defensive", "under"})
...
def is_avail_sensitive(family: str, cfg_gates: dict) -> bool:
    if bool(cfg_gates.get("lineup_gate_all_football") or cfg_gates.get("gate_all_markets")):
        return True
