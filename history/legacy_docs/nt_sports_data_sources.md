...
- web_search "best data sources for football player goalscorer props anytime first goal xG xA assister stats historical" → [web:63-72] FBref (player xG/shooting/assists historical), Understat (xG/xA/shot maps for location/quality modeling), WhoScored (event data, big chances, assists, ratings for contextual edge).
...
---
*End of nt_sports_data_sources.md - Compiled following robust_betting_protocol_v2.md by the letter in full. VERIFIED BEST as of 2026-06-24. Deep complex odds update 2026-06-25. Clean Restart 2026-06-28: Per-sport step-by-step checklists finalized and enforced (soccer: lineups/starting XI 3+ sources first + motivation/H2H/recent form/weather/ref/VAR/xG/historical from FBref etc priority; other sports adapted equivalents). Autonomous mode active.*