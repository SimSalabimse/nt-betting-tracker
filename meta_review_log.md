...
- **Standardized Summary + Learnings**:
  ...
  - Bankroll/Edges Impact: Prior R32 bets impacted by variance (e.g., Germany -1, Netherlands win losses); new filters added to sport_edges (WC R32 heavy favorite ML/HC tighten; promote Under 2.5/set-piece alts in motivated underdog profiles).
