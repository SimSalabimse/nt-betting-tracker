# Round 2026-06-04 Recommendations

**Bankroll**: 500 NOK  
**Staking**: Transition round at 10 NOK. **Moderate acceleration now active** (15-25 NOK flat per high-conviction bet from next round; up to 4-6 bets/round allowed when good +EV opportunities exist. Daily portfolio risk target ~60-100 NOK).  
**Total Risk This Round**: 30 NOK  
**Structure**: 3 Singles

## Recommended Bets (Placed by User)

| # | Sport | Match | Selection | Odds | Stake | Est. EV | Key Reasoning |
|---|-------|-------|-----------|------|-------|---------|---------------|
| 1 | Tennis | Mensik vs Zverev (RG SF) | Zverev to win | 1.25 | 10 NOK | +3-6% | Experience + H2H + fatigue on Mensik |
| 2 | NHL | Hurricanes vs Golden Knights (SCF G2) | Under 5.5 Total Goals | ~1.95 | 10 NOK | +2-5% | Defensive tightening expected |
| 3 | WNBA | Minnesota Lynx vs Golden State Valkyries | Lynx ML | Check platform | 10 NOK | ~+4% | Stronger form & defense |

**Notes**: 
- Honest math acknowledged: Modest profit potential due to low-odds anchor leg.
